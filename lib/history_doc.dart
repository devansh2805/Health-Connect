...
class HistoryDocScreen extends StatefulWidget {
  const HistoryDocScreen({Key? key, required this.patUid}) : super(key: key);
  final String patUid;
  @override
  State<HistoryDocScreen> createState() => _HistoryDocScreenState();
}

class _HistoryDocScreenState extends State<HistoryDocScreen> {
  @override
